...
parse_information_element(?M_IT_NA_1, <<BCR:40>>) ->
  <<Value:32/little-signed, _Ignored:8>> = <<BCR:40>>,
  #{value => Value, bcr => BCR};
...
create_information_element(?M_ST_TA_1, #{
  ...
  <<State:1, _Ignored:7>> = <<VTI>>,
  <<State:1, Value:7/signed, QDS, Timestamp/binary>>;
...
create_information_element(?M_BO_TA_1, #{
  ...
  <<BSI:32/little-unsigned, QDS, Timestamp/binary>>;
...
create_information_element(?M_ME_TA_1, #{
  ...
  <<NVA:16/little-signed-float, QDS, Timestamp/binary>>;
...
create_information_element(?M_ME_TB_1, #{
  ...
  <<SVA:16/little-signed, QDS, Timestamp/binary>>;
...
create_information_element(?M_ME_TC_1, #{
  ...
  <<Value:32/little-signed-float, QDS, Timestamp/binary>>;
...
create_information_element(?M_IT_TA_1, #{
  ...
  <<_Ignore:32, Rest>> = <<BCR:40>>,
  <<Value:32/little-signed, Rest, Timestamp/binary>>;
...
create_information_element(?M_EP_TA_1, #{
  ...
  <<Rest:6, ES:2, Duration:16, Timestamp/binary>>;
...
create_information_element(?M_EP_TB_1, #{
  ...
  <<SPE, QDP, Duration:16, Timestamp/binary>>;

%% Type 19. Packed output circuit information of protection equipment with time tag
create_information_element(?M_EP_TC_1, #{
  value := OCI,
  qdp := QDP,
  duration := Timestamp16,
  ts := Timestamp24
}) ->
  <<OCI, QDP, Timestamp16:16, Timestamp24/binary>>;
...
create_information_element(?M_ST_TB_1, #{
  ...
  <<State:1, _Ignored:7>> = <<VTI>>,
  <<State:1, Value:7, QDS, Timestamp/binary>>;
...
create_information_element(?M_IT_TB_1, #{
  ...
  <<Value:32/little-signed, Rest:8, Timestamp/binary>>;
...
create_information_element(?M_EP_TD_1, #{
  ...
  <<SEP, Interval:16/little-unsigned, Timestamp/binary>>;
